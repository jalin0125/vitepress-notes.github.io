import{_ as s,c as n,o as a,a as l}from"./app.c4f3a98b.js";const f=JSON.parse('{"title":"开发标准","description":"","frontmatter":{},"headers":[{"level":2,"title":"统一注释","slug":"统一注释","link":"#统一注释","children":[]}],"relativePath":"01.basics/01.preknowledge/01.standard.md"}'),p={name:"01.basics/01.preknowledge/01.standard.md"},t=l(`<h1 id="开发标准" tabindex="-1">开发标准 <a class="header-anchor" href="#开发标准">¶</a></h1><h2 id="统一注释" tabindex="-1">统一注释 <a class="header-anchor" href="#统一注释">¶</a></h2><div class="language-css"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">/* </span></span>
...
<span class="line"></span></code></pre></div>`,4),o=[t];function e(c,i,r,y,F,D){return a(),n("div",null,o)}const C=s(p,[["render",e]]);export{f as __pageData,C as default};
